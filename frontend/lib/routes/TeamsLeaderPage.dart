...
import 'package:frontend/routes/AddEventLeaderPage.dart';
import '../components/TeamTile.dart';
import '../components/NotificationTile.dart';

class TeamsLeaderPage extends StatefulWidget {
  TeamsLeaderPage({super.key, required this.theme});
  final Map theme;
  State<TeamsLeaderPage> createState() => _TeamsLeaderPageState();
}

class _TeamsLeaderPageState extends State<TeamsLeaderPage> {
                      ...
                      onPressed: () => Navigator.of(context).push(
                          MaterialPageRoute(
                              builder: (BuildContext context) =>
                                  AddEventLeaderPage(theme: widget.theme))),
                    ))
              ],
            ),
            SizedBox(height: 40)
